	...
	return (
		<div ref={divRef}>
			<div className='lg:hidden relative flex'>
				<Sidebar />
				<div className='lg:hidden mb-5 flex-1 flex flex-col bg-gradient-to-br from-black to-[#121286]'>
					<Searchbar />
				</div>
			</div>
				...
				<div className='w-full flex flex-col mt-8'>
					...
					>
						{topPlays?.map((artist) => (
							...
							>
								{console.log(artist.artists[0].adamid)}
								<Link
									to={`/artists/${artist.artists[0].adamid}`}
								>
									<img
